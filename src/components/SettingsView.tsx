    ...
    <div className="space-y-6 font-sans">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 space-y-6">
          <form onSubmit={handleSubmit} className="bg-white p-6 rounded border border-[#E5E2D9] shadow-sm space-y-5">
            <h3 className="text-[10px] font-bold uppercase tracking-widest text-[#2D2926] font-mono flex items-center gap-1.5">
              <Bot className="h-4.5 w-4.5 text-[#E27D60]" />
            ...
            <div className="space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="space-y-1.5">
                  <label className="text-[10px] font-bold text-slate-600 uppercase tracking-widest font-mono">
                    Telegram Bot Token
                  </label>
                  <input
                    type="password"
                    ...
                    className="w-full text-xs bg-[#F8F7F3] border border-[#E5E2D9] rounded px-3 py-2.5 text-[#2D2926] placeholder-slate-400 focus:outline-none focus:border-[#E27D60] focus:bg-white transition-all"
                  />
                </div>
              ...
              <div className="flex items-center gap-2">
                <input
                  ...
                  className="h-4 w-4 text-[#E27D60] border-[#E5E2D9] rounded focus:ring-[#E27D60]"
                />
                <label htmlFor="isActive" className="text-xs font-bold uppercase tracking-wider text-slate-700 font-mono">
                  Enable active Telegram messaging channel
                </label>
              </div>
            </div>

            <div className="flex items-center justify-between border-t border-[#E5E2D9] pt-4">
              {showSuccess ? (
                <span className="text-xs font-bold text-emerald-600 flex items-center gap-1 font-mono uppercase tracking-wider">
              ...
              <button
                type="submit"
                disabled={isSaving}
                className="flex items-center gap-1.5 px-4 py-2 bg-[#E27D60] hover:bg-[#E27D60]/90 text-white font-bold text-xs uppercase tracking-wider rounded transition-colors disabled:opacity-50 shadow-sm"
              >
        ...
        <div className="space-y-6">
          <div className="bg-white p-5 rounded border border-[#E5E2D9] shadow-sm space-y-4">
            ...
            <button
              ...
              className="w-full py-2 bg-rose-50 hover:bg-rose-100 border border-rose-200/40 text-rose-700 rounded text-xs font-bold uppercase tracking-wider transition-all disabled:opacity-50"
            >
          ...
          <div className="bg-[#E27D60]/5 p-4 rounded border border-[#E27D60]/20 flex gap-3 items-start">
            <ShieldCheck className="h-5 w-5 text-[#E27D60] flex-shrink-0 mt-0.5" />
            <div className="space-y-1 text-xs">
              <span className="font-bold text-[#E27D60] text-[10px] uppercase tracking-widest font-mono block">Phase 0 Guidelines</span>
